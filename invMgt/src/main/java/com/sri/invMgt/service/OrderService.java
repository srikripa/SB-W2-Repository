package com.sri.invMgt.service;
...
import com.sri.invMgt.repository.CustomerRepository;
import com.sri.invMgt.repository.OrderRepository;
import com.sri.invMgt.repository.ProductRepository;
import com.sri.invMgt.util.MembershipLevel;
import com.sri.invMgt.util.OrderStatus;
...
public class OrderService {
	...
	public Order cancelOrder(Long orderId) throws Exception		{
		try	{
			...
			order.setStatus(OrderStatus.CANCELED);return repo.save(order);
		}	catch (Exception e)		{
